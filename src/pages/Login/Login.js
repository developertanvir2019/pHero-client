...
const Login = () => {
    ...
    return (
        <div className='flex justify-center items-center py-6 bg-gradient-to-r from-secondary to-yellow-300'>
            <div className='flex flex-col max-w-md p-6 rounded-md sm:p-10 bg-gray-100 text-gray-900'>
                ...
                <div className='flex items-center pt-4 space-x-1'>
                    ...
                    <p className='px-3 text-sm dark:text-gray-400'>
                        Login with <span className='text-secondary font-bold'>social</span> accounts
                    </p>
                    <div className='flex-1 h-px sm:w-16 dark:bg-gray-700'></div>
                </div>
                ...
                <p className='px-6 text-sm text-center text-gray-400'>
                    Don't have account?{' '}
                    <Link to='/signup' className='hover:underline text-info'>
                        Sign up
                    </Link>
                    .
                </p>
